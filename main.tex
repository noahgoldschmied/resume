...
\begin{center}
    \textbf{\Huge \scshape Noah Goldschmied} \\ \vspace{3pt}
    \small
    \faMobile \hspace{.5pt} \href{tel:6478018445}{(647) 801-8445}
    $|$
    ...
    $|$
    \faMapMarker \hspace{.5pt} Toronto, ON, CA
\end{center}
...
\section{Education}
  ...
  \resumeSubHeadingListStart
    \resumeEducationHeading
      ...
      {\href{https://www.eng.mcmaster.ca/cas/degree-options/software-engineering-and-management/}{B.Eng.Mgt in Software Engineering and Management}}{Sep. 2021 -- Apr. 2027 (Expected)}
